...
# v128 · the Q&A tab sits second
ok("tab order desk→qa→macro→ois→micro→pack→validation→forex→comm→intl→news", tabs == ['desk','qa','macro','ois','micro','pack','validation','forex','comm','intl','news'])
